            ...
            {step === 1 ? (
              ...
              <div className="animate-fade-in space-y-4">
                <div className="text-center mb-6">
                  <div className="bg-primary-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-primary-600">
                ...
                <Input
                  label="Authentication Code (Demo: 123456)"
                  type="text"
                  value={otp}
